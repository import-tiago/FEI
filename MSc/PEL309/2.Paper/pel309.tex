...
\end{equation}
Equation~\ref{eq:dac_estimation_model} is valid only within the experimentally selected compliance region. Outside this region, the output current is constrained by available output voltage and load resistance, and the DAC-to-current model may predict a current that cannot be physically delivered once the output stage reaches voltage compliance.
