...
Figure~\ref{fig:binned_with_rest} shows the output current versus DAC voltage after DAC-axis binning while still preserving the resting regime. This intermediate representation documents the complete acquisition path before ramp-only selection and shows the non-ramp samples around the nominal DAC reference.
