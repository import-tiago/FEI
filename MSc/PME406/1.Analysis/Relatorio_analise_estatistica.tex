...
Este ajuste foi usado para verificar se a relação entre tensão de DAC e
corrente é a mesma para todas as cargas ou se muda levemente conforme a
carga conectada. No modelo global, uma única reta é usada para
representar todas as cargas, assumindo o mesmo intercepto e a mesma
inclinação. Ao incluir a interação entre carga e comando de DAC, por
outro lado, a carga pode alterar tanto o deslocamento vertical da reta
quanto sua inclinação:
\[
...
comando do DAC. Os parâmetros do modelo são:
...
Neste ajuste, portanto, a carga de 1 kOhm é tomada como referência; os
termos associados a 2 kOhm e 4,7 kOhm indicam quanto essas cargas se
afastam da reta de referência.
...
- 1{,}0877\,R_{2k}
- 3{,}6991\,R_{4{,}7k}\\
&+ 0{,}5210\,V_{\mathrm{DAC}}\,[\mathrm{V}]\,R_{2k}
+ 1{,}9616\,V_{\mathrm{DAC}}\,[\mathrm{V}]\,R_{4{,}7k},
\end{aligned}
\]
em que \(R_{2k}\) é uma variável indicadora que vale 1 quando a carga
resistiva é 2 kOhm e 0 nos demais casos, e \(R_{4{,}7k}\) é uma variável
...
pois ela é a referência do modelo. Aqui, \(R_{2k}\) e \(R_{4{,}7k}\) não
representam o valor da resistência em ohms, mas apenas a presença daquela
carga no ajuste.
